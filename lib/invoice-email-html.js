        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td align="center" valign="middle" style="height:130px;background-color:#ffffff;border-radius:12px 12px 0 0;" height="130">
              <img src="${p.merchant_logo}" alt="${p.merchant_name}" style="border-radius:12px;max-height:60px;max-width:160px;display:block;" />
            </td>
          </tr>
          <!-- Body -->
          <tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td align="center" style="font-size:15px;color:#8898aa;padding-bottom:28px;font-weight:400;line-height:18px;font-family:'Roboto',Arial,Helvetica,sans-serif;">
                    <a style="text-decoration: none; color:#8898aa; appearance: none; font-family:'Roboto',Arial,Helvetica,sans-serif;" href="mailto:${p.order_email}">${p.order_email.replace('@', '&#64;')}</a> &mdash; Payment on hold
                  </td>
                </tr>
              </table> 
              <!-- Meta row -->
