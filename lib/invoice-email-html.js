              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td align="center" style="font-size:15px;color:#8898aa;padding-bottom:28px;font-weight:400;line-height:18px;font-family:'Roboto',Arial,Helvetica,sans-serif;">
                    <a style="text-decoration: none; color:#8898aa; appearance: none; font-family:'Roboto',Arial,Helvetica,sans-serif;" href="mailto:${p.order_email}">${p.order_email.replace('@', '&#64;')}</a> &mdash; Payment on hold${p.ref ? ' &mdash; Ref ' + p.ref : ''}
                  </td>
                </tr>
              </table> 
              <!-- Meta row -->
