 ...
 * @returns {{ accountId: number, clientId: string, apiKey: string, index: number } | { error: string }}
 */
 ...
 * @returns {{ accountId: number, clientId: string, apiKey: string, accountIndex: number } | { error: string, status?: number }}
 */
